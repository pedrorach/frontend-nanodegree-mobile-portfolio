...
var resizePizzas = function(size) {
    ...
    // OPTIMIZATION: Simple fixed size switch instead of calculation of size differences.
    //               Substituted querySelectorAll by getElementsByClassName
    //               Creater var randomPizzas and moved getElement out of the for loop.
    var newWidth = 0;
...
function updatePositions() {
    ...
    // OPTIMIZATION: Created var for document.body.scrollTop to move it outside the for loop.
    //               Substituted querySelectorAll by getElementsByClassName
...
// OPTIMIZATION: reduced number of Pizzas from 200 to 35.
